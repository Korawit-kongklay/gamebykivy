...
class MainMenu(BoxLayout):
    def __init__(self, **kwargs):
        ...
        self.menu_music_volume = 1.0  # เก็บค่า volume สำหรับส่งต่อ
    ...
    def start_game(self, instance):
        """Switch to the game screen and pass music volume."""
        self.music_manager.stop_music()  # หยุดเพลงเมนู
        app = App.get_running_app()
        app.root.clear_widgets()
        game = Game()
        game.music_manager.current_music.volume = self.menu_music_volume  # ส่งต่อค่า volume
        app.root.add_widget(game)

    def show_settings(self, instance):
        """Show settings popup with volume control."""
        settings_content = BoxLayout(orientation='vertical', padding=10, spacing=10)
        
        # Volume Slider
        volume_label = Label(text='Background Music Volume')
        settings_content.add_widget(volume_label)
        ...
        settings_content.add_widget(volume_slider)
    ...
    def on_volume_change(self, instance, value):
        ...
        self.menu_music_volume = value  # เก็บค่าเพื่อส่งต่อ
